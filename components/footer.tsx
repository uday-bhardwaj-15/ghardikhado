    ...
    <footer className="bg-deep-ebony text-soft-ivory py-16">
      <div className="container mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-2xl font-bold font-times-new-roman mb-4">
              LUXURY
            </h3>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4 font-times-new-roman">
              Quick Links
            </h4>
            <ul className="space-y-2">
              <li>
                <Link
                  href="/properties"
                  className="block hover:text-warm-gold transition-colors duration-300"
                >
                  Properties
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-muted-charcoal hover:text-warm-gold transition-colors duration-300"
              >
                Facebook
              </a>
              <a
